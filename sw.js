...
const CACHE='moovon-presentation-v3';
const FILES=['./','index.html','admin.html','app.css','demo-shell.css','stories.css','admin.css','app.js','demo-shell.js','stories.js','admin.js','demo-store.js','icon.svg','manifest.webmanifest'];
