...
2. La photo occupe toute la largeur, avec les boutons **Aa**, stickers et **…** superposés à droite. Toucher la photo pour écrire : pendant la saisie, le texte est placé dans la zone visible au-dessus du clavier, sans réduire la photo. Choisir la police dans les pastilles du bas, la couleur avec le bouton multicolore, le fond et l’alignement ; le curseur à gauche règle la taille. **Terminé** replace le texte à l’endroit choisi sur la photo. Toucher un texte existant pour le corriger ; hors saisie, le glisser pour le déplacer (ou utiliser les flèches du clavier). Jusqu’à six textes ou stickers peuvent être modifiés ou supprimés avant publication.
   **Ajoutez une légende…** ou **…** ouvre les options : légende, changement de photo et confidentialité. **Trajet masqué / Trajet visible** est aussi accessible directement en bas. Fermer les options puis **Votre story** pour publier. Aucune publication n’est effectuée lors de la prise de photo. La disposition des textes et stickers est conservée à la lecture et après rechargement.
